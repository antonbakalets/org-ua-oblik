...
<ul class="list-group">
    <li class="list-group-item active">
        <h4 class="panel-title"><spring:message code="jsp.oblik.account.expense"/></h4>
    </li>
    <c:forEach var="entry" items="${expenseAccounts}">
        <li class="list-group-item account-expense">
            <div class="edit-link">
                ...
                <a id="account_${entry.accountId}" class="btn btn-link btn-xs pull-right"
                   href="${pageContext.request.contextPath}/account/edit.html?accountId=${entry.accountId}&type=EXPENSE">
